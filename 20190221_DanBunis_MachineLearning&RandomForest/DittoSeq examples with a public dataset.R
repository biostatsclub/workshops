...
#########################################################################################################
# If you downloaded the data from the biostats github, this first section was already run. Skip on down.#
# If not, download from the link below, then run all code.                                              #
#########################################################################################################
